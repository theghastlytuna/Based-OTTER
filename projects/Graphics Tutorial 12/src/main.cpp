...
void CreateScene() {
	...
	if (loadScene) {
		...
		MeshResource::Sptr terrainMesh = ResourceManager::CreateAsset<MeshResource>("plane.obj");
		...
		Material::Sptr terrainMaterial = ResourceManager::CreateAsset<Material>(terrainShader);
		{
			Texture2D::Sptr grass = ResourceManager::CreateAsset<Texture2D>("textures/terrain/grass.png");
			Texture2D::Sptr sand = ResourceManager::CreateAsset<Texture2D>("textures/terrain/sand.png");
			Texture2D::Sptr stone = ResourceManager::CreateAsset<Texture2D>("textures/stone.jpg");
			Texture2D::Sptr displacementMap = ResourceManager::CreateAsset<Texture2D>("textures/heightmap.bmp");

			terrainMaterial->Name = "Terrain Material";
			terrainMaterial->Set("u_Material.DiffuseA", sand);
			terrainMaterial->Set("u_Material.DiffuseB", grass);
			terrainMaterial->Set("u_Material.DiffuseC", stone);
			terrainMaterial->Set("u_Material.Shininess", 0.5f);
			terrainMaterial->Set("s_Heightmap", displacementMap);
			terrainMaterial->Set("u_Scale", 0.8f);
		}
		Material::Sptr waterMaterial = ResourceManager::CreateAsset<Material>(waterShader);
		{
			Texture2D::Sptr water = ResourceManager::CreateAsset<Texture2D>("textures/water.jpg");

			waterMaterial->Name = "Water Material";
			waterMaterial->Set("u_Material.Diffuse", water);
			waterMaterial->Set("u_Material.Shininess", 0.5f);
			waterMaterial->Set("u_Scale", 20.f);
		} 
		...
		GameObject::Sptr terrain = scene->CreateGameObject("Terrain");
		{
			terrain->SetScale(glm::vec3(4.f));
		...
		{
			water->SetPostion(glm::vec3(0.f, 0.f, 0.8f));
			water->SetScale(glm::vec3(4.f));
