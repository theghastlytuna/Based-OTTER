...
int main() {
	...
	ComponentManager::RegisterType<PuckResetBehaviour>();
	...
	if (loadScene) {
		...
		MeshResource::Sptr playerMesh = ResourceManager::CreateAsset<MeshResource>("Player_Piece.obj");
		...
		Texture2D::Sptr blueTexture = ResourceManager::CreateAsset<Texture2D>("textures/blue.png");
		Texture2D::Sptr boxTexture = ResourceManager::CreateAsset<Texture2D>("textures/black.png");
		Texture2D::Sptr floorTexture = ResourceManager::CreateAsset<Texture2D>("textures/floor.png");

		//number textures
		Texture2D::Sptr zeroTexture = ResourceManager::CreateAsset<Texture2D>("textures/0.png");
		Texture2D::Sptr oneTexture = ResourceManager::CreateAsset<Texture2D>("textures/1.png");
		Texture2D::Sptr twoTexture = ResourceManager::CreateAsset<Texture2D>("textures/2.png");
		Texture2D::Sptr threeTexture = ResourceManager::CreateAsset<Texture2D>("textures/3.png");
		Texture2D::Sptr fourTexture = ResourceManager::CreateAsset<Texture2D>("textures/4.png");
		Texture2D::Sptr fiveTexture = ResourceManager::CreateAsset<Texture2D>("textures/5.png");
		Texture2D::Sptr sixTexture = ResourceManager::CreateAsset<Texture2D>("textures/6.png");
		Texture2D::Sptr sevenTexture = ResourceManager::CreateAsset<Texture2D>("textures/7.png");
		Texture2D::Sptr eightTexture = ResourceManager::CreateAsset<Texture2D>("textures/8.png");
		Texture2D::Sptr nineTexture = ResourceManager::CreateAsset<Texture2D>("textures/9.png");
		...
		Material::Sptr redPlayerMaterial = ResourceManager::CreateAsset<Material>();
		{
			redPlayerMaterial->Name = "RedPlayer";
			redPlayerMaterial->MatShader = scene->BaseShader;
			redPlayerMaterial->Texture = redTexture;
			redPlayerMaterial->Shininess = 256.0f;
		}

		Material::Sptr bluePlayerMaterial = ResourceManager::CreateAsset<Material>();
		{
			bluePlayerMaterial->Name = "BluePlayer";
			bluePlayerMaterial->MatShader = scene->BaseShader;
			bluePlayerMaterial->Texture = blueTexture;
			bluePlayerMaterial->Shininess = 256.0f;
		}

		Material::Sptr floorMaterial = ResourceManager::CreateAsset<Material>();
		{
			floorMaterial->Name = "floor";
			floorMaterial->MatShader = scene->BaseShader;
			floorMaterial->Texture = floorTexture;
			floorMaterial->Shininess = 256.0f;
		}
		...
		Material::Sptr puckMaterial = ResourceManager::CreateAsset<Material>();
		{
			...
			puckMaterial->Texture = boxTexture;
			puckMaterial->Shininess = 256.0f;
		}

		//number materials

		Material::Sptr zeroMaterial = ResourceManager::CreateAsset<Material>();
		{
			zeroMaterial->Name = "zero";
			zeroMaterial->MatShader = scene->BaseShader;
			zeroMaterial->Texture = zeroTexture;
			zeroMaterial->Shininess = 10.0f;
		}
		Material::Sptr oneMaterial = ResourceManager::CreateAsset<Material>();
		{
			oneMaterial->Name = "one";
			oneMaterial->MatShader = scene->BaseShader;
			oneMaterial->Texture = oneTexture;
			oneMaterial->Shininess = 10.0f;
		}
		Material::Sptr twoMaterial = ResourceManager::CreateAsset<Material>();
		{
			twoMaterial->Name = "two";
			twoMaterial->MatShader = scene->BaseShader;
			twoMaterial->Texture = twoTexture;
			twoMaterial->Shininess = 10.0f;
		}
		Material::Sptr threeMaterial = ResourceManager::CreateAsset<Material>();
		{
			threeMaterial->Name = "three";
			threeMaterial->MatShader = scene->BaseShader;
			threeMaterial->Texture = threeTexture;
			threeMaterial->Shininess = 10.0f;
		}
		Material::Sptr fourMaterial = ResourceManager::CreateAsset<Material>();
		{
			fourMaterial->Name = "four";
			fourMaterial->MatShader = scene->BaseShader;
			fourMaterial->Texture = fourTexture;
			fourMaterial->Shininess = 10.0f;
		}
		Material::Sptr fiveMaterial = ResourceManager::CreateAsset<Material>();
		{
			fiveMaterial->Name = "five";
			fiveMaterial->MatShader = scene->BaseShader;
			fiveMaterial->Texture = fiveTexture;
			fiveMaterial->Shininess = 10.0f;
		}
		Material::Sptr sixMaterial = ResourceManager::CreateAsset<Material>();
		{
			sixMaterial->Name = "six";
			sixMaterial->MatShader = scene->BaseShader;
			sixMaterial->Texture = sixTexture;
			sixMaterial->Shininess = 10.0f;
		}
		Material::Sptr sevenMaterial = ResourceManager::CreateAsset<Material>();
		{
			sevenMaterial->Name = "seven";
			sevenMaterial->MatShader = scene->BaseShader;
			sevenMaterial->Texture = sevenTexture;
			sevenMaterial->Shininess = 10.0f;
		}
		Material::Sptr eightMaterial = ResourceManager::CreateAsset<Material>();
		{
			eightMaterial->Name = "eight";
			eightMaterial->MatShader = scene->BaseShader;
			eightMaterial->Texture = eightTexture;
			eightMaterial->Shininess = 10.0f;
		}
		Material::Sptr nineMaterial = ResourceManager::CreateAsset<Material>();
		{
			nineMaterial->Name = "nine";
			nineMaterial->MatShader = scene->BaseShader;
			nineMaterial->Texture = nineTexture;
			nineMaterial->Shininess = 10.0f;
		}

		Material::Sptr numberMats[] = { zeroMaterial, oneMaterial, twoMaterial,
			threeMaterial, fourMaterial, fiveMaterial, sixMaterial, sevenMaterial, eightMaterial, nineMaterial };

		// Create some lights for our scene
		scene->Lights.resize(3);
		scene->Lights[0].Position = glm::vec3(11.0f, 0.0f, 3.0f);
		scene->Lights[0].Color = glm::vec3(1.f, 0.0f, 0.f);
		scene->Lights[0].Range = 25.0f;

		scene->Lights[1].Position = glm::vec3(-11.0f, 0.0f, 3.0f);
		scene->Lights[1].Color = glm::vec3(0.f, 0.05f, 1.f);
		scene->Lights[1].Range = 25.0f;

		scene->Lights[2].Position = glm::vec3(0.0f, 0.0f, 3.0f);
		scene->Lights[2].Color = glm::vec3(1.0f, 1.f, 1.0f);
		...
		boxMesh->AddParam(MeshBuilderParam::CreateCube(ZERO, ONE, ZERO));
		boxMesh->GenerateMesh();

		// Set up the scene's camera
		GameObject::Sptr camera = scene->CreateGameObject("Main Camera");
		{
			camera->SetPostion(glm::vec3(0, 0.1, 14));
		...
		{
			// Scale up the plane
			floor->SetScale(glm::vec3(26.0F, 16.f, 10.f));
		...
		//walls
		{
			//big wall bodies are scale 12, small walls are 2.6
			GameObject::Sptr wall1 = scene->CreateGameObject("Wall1");
			{
				...
				wall1->SetScale(glm::vec3(25.f, 1.f, 1.f));
				wall1->SetPostion(glm::vec3(0.f, -8.f, 0.f));

				RigidBody::Sptr physics = wall1->Add<RigidBody>();
				physics->AddCollider(BoxCollider::Create(glm::vec3(12.f, 1.f, 1.f)));
			}
			GameObject::Sptr wall2 = scene->CreateGameObject("Wall2");
			{
				...
				physics->AddCollider(BoxCollider::Create(glm::vec3(1.f, 2.6f, 1.f)));

				wall2->SetPostion(glm::vec3(13.f, -6.f, 0.f));
				wall2->SetScale(glm::vec3(1.f, 5.5f, 1.f));
			...
			GameObject::Sptr wall3 = scene->CreateGameObject("Wall3");
			{
				...
				wall3->SetPostion(glm::vec3(13.f, 6.f, 0.f));
				wall3->SetScale(glm::vec3(1.f, 5.5f, 1.f));
			...
			GameObject::Sptr wall4 = scene->CreateGameObject("Wall4");
			{
				...
				wall4->SetPostion(glm::vec3(0.f, 8.f, 0.f));
				wall4->SetScale(glm::vec3(25.f, 1.f, 1.f));
			...
			GameObject::Sptr wall5 = scene->CreateGameObject("Wall5");
			{
				...
				wall5->SetPostion(glm::vec3(-13.f, 6.f, 0.f));
				wall5->SetScale(glm::vec3(1.f, 5.5f, 1.f));
			...
			GameObject::Sptr wall6 = scene->CreateGameObject("Wall6");
			{
				...
				wall6->SetPostion(glm::vec3(-13.f, -6.f, 0.f));
				wall6->SetScale(glm::vec3(1.f, 5.5f, 1.f));
		...
		{
			puck->SetPostion(glm::vec3(0.f, 0.f, 0.f));
			...
			physics->AddCollider(CylinderCollider::Create(glm::vec3(1.f, 1.f, 0.5f)));
			physics->SetMass(1.f);
			physics->SetAngularDamping(100.f);
			physics->SetLinearDamping(0.0f);

			PuckResetBehaviour::Sptr behaviour = puck->Add<PuckResetBehaviour>();
		}

		GameObject::Sptr redPlayer = scene->CreateGameObject("Red Player");
		{
			redPlayer->SetPostion(glm::vec3(10.f, 0.f, 0.f));

			RenderComponent::Sptr renderer = redPlayer->Add<RenderComponent>();
			renderer->SetMesh(playerMesh);
			renderer->SetMaterial(redPlayerMaterial);

			RigidBody::Sptr physics = redPlayer->Add<RigidBody>(RigidBodyType::Kinematic);
			physics->AddCollider(CylinderCollider::Create(glm::vec3(1.f, 1.f, 1.f)));

			SimpleCameraControl::Sptr control = redPlayer->Add<SimpleCameraControl>();
			control->mouseControl = true;
		}

		GameObject::Sptr bluePlayer = scene->CreateGameObject("Blue Player");
		{
			bluePlayer->SetPostion(glm::vec3(-10.f, 0.f, 0.f));

			RenderComponent::Sptr renderer = bluePlayer->Add<RenderComponent>();
			renderer->SetMesh(playerMesh);
			renderer->SetMaterial(bluePlayerMaterial);

			RigidBody::Sptr physics = bluePlayer->Add<RigidBody>(RigidBodyType::Kinematic);
			physics->AddCollider(CylinderCollider::Create(glm::vec3(1.f, 1.f, 1.f)));

			SimpleCameraControl::Sptr control = bluePlayer->Add<SimpleCameraControl>();
			control->mouseControl = false;
		}

		GameObject::Sptr redGoal = scene->CreateGameObject("Red Goal");
		{
			redGoal->SetPostion(glm::vec3(-7.f, -6.4f, 3.f));
			redGoal->SetRotation(glm::vec3(0.f, 0.f, 180.f));
			redGoal->SetScale(glm::vec3(1.f, 1.f, 1.f));

			BoxCollider::Sptr collider = BoxCollider::Create(glm::vec3(1.0f, 4.0f, 1.0f));
			collider->SetPosition(glm::vec3(-21.0f, -6.5f, -2.0f));

			TriggerVolume::Sptr volume = redGoal->Add<TriggerVolume>();
			volume->AddCollider(collider);

			RenderComponent::Sptr renderer = redGoal->Add<RenderComponent>();
			renderer->SetMesh(planeMesh);
			renderer->SetMaterial(zeroMaterial);

			ScoreCounter::Sptr counter = redGoal->Add<ScoreCounter>();
			for (int i = 0; i < 10; i++)
			{
				counter->numberArray[i] = numberMats[i];
			}

		}

		GameObject::Sptr blueGoal = scene->CreateGameObject("Blue Goal");
		{
			blueGoal->SetPostion(glm::vec3(7.f, -6.4f, 3.f));
			blueGoal->SetRotation(glm::vec3(0.f, 0.f, 180.f));
			blueGoal->SetScale(glm::vec3(1.f, 1.f, 1.f));

			BoxCollider::Sptr collider = BoxCollider::Create(glm::vec3(1.0f, 4.0f, 1.0f));
			collider->SetPosition(glm::vec3(21.0f, -6.5f, -2.0f));

			TriggerVolume::Sptr volume = blueGoal->Add<TriggerVolume>();
			volume->AddCollider(collider);

			RenderComponent::Sptr renderer = blueGoal->Add<RenderComponent>();
			renderer->SetMesh(planeMesh);
			renderer->SetMaterial(zeroMaterial);

			ScoreCounter::Sptr counter = blueGoal->Add<ScoreCounter>();
			for (int i = 0; i < 10; i++)
			{
				counter->numberArray[i] = numberMats[i];
			}
	...
	while (!glfwWindowShouldClose(window)) {
		...
		if (isDebugWindowOpen) {
			...
			ImGui::Separator();
			ImGui::DragFloat("Global Light", &ambientLight, 0.001f, 0.0f, 1.0f);
			if (ImGui::Button("Apply"))
			{
				scene->SetAmbientLight(glm::vec3(ambientLight));
			}
